...
for k = 1:N-2
    ...
    u_dual_1(k+1) = ((input_ref(k+1)-theta_1(1)*w_f'*h_f(:,k+1)-theta_1(3))*(theta_1(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P1(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P1(3,3,k+1)+(theta_1(2)*w_g'*h_g(:,k+1))^2);
    u_dual_2(k+1) = ((input_ref(k+1)-theta_2(1)*w_f'*h_f(:,k+1)-theta_2(3))*(theta_2(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P2(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P2(3,3,k+1)+(theta_2(2)*w_g'*h_g(:,k+1))^2);
    u_dual_3(k+1) = ((input_ref(k+1)-theta_3(1)*w_f'*h_f(:,k+1)-theta_3(3))*(theta_3(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P3(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P3(3,3,k+1)+(theta_3(2)*w_g'*h_g(:,k+1))^2);
    u_dual_4(k+1) = ((input_ref(k+1)-theta_4(1)*w_f'*h_f(:,k+1)-theta_4(3))*(theta_4(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P4(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P4(3,3,k+1)+(theta_4(2)*w_g'*h_g(:,k+1))^2);
    u_dual_5(k+1) = ((input_ref(k+1)-theta_5(1)*w_f'*h_f(:,k+1)-theta_5(3))*(theta_5(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P5(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P5(3,3,k+1)+(theta_5(2)*w_g'*h_g(:,k+1))^2);
    u_dual_6(k+1) = ((input_ref(k+1)-theta_6(1)*w_f'*h_f(:,k+1)-theta_6(3))*(theta_6(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P6(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P6(3,3,k+1)+(theta_6(2)*w_g'*h_g(:,k+1))^2);
    u_dual_7(k+1) = ((input_ref(k+1)-theta_7(1)*w_f'*h_f(:,k+1)-theta_7(3))*(theta_7(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P7(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P7(3,3,k+1)+(theta_7(2)*w_g'*h_g(:,k+1))^2);
    u_dual_8(k+1) = ((input_ref(k+1)-theta_8(1)*w_f'*h_f(:,k+1)-theta_8(3))*(theta_8(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P8(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P8(3,3,k+1)+(theta_8(2)*w_g'*h_g(:,k+1))^2);
    u_dual_9(k+1) = ((input_ref(k+1)-theta_9(1)*w_f'*h_f(:,k+1)-theta_9(3))*(theta_9(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P9(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P9(3,3,k+1)+(theta_9(2)*w_g'*h_g(:,k+1))^2);
    u_dual_10(k+1) = ((input_ref(k+1)-theta_10(1)*w_f'*h_f(:,k+1)-theta_10(3))*(theta_10(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P10(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P10(3,3,k+1)+(theta_10(2)*w_g'*h_g(:,k+1))^2);
    u_dual_11(k+1) = ((input_ref(k+1)-theta_11(1)*w_f'*h_f(:,k+1)-theta_11(3))*(theta_11(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P11(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P11(3,3,k+1)+(theta_11(2)*w_g'*h_g(:,k+1))^2);
    u_dual_12(k+1) = ((input_ref(k+1)-theta_12(1)*w_f'*h_f(:,k+1)-theta_12(3))*(theta_12(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P12(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P12(3,3,k+1)+(theta_12(2)*w_g'*h_g(:,k+1))^2);
    u_dual_13(k+1) = ((input_ref(k+1)-theta_13(1)*w_f'*h_f(:,k+1)-theta_13(3))*(theta_13(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P13(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P13(3,3,k+1)+(theta_13(2)*w_g'*h_g(:,k+1))^2);
    u_dual_14(k+1) = ((input_ref(k+1)-theta_14(1)*w_f'*h_f(:,k+1)-theta_14(3))*(theta_14(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P14(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P14(3,3,k+1)+(theta_14(2)*w_g'*h_g(:,k+1))^2);
    u_dual_15(k+1) = ((input_ref(k+1)-theta_15(1)*w_f'*h_f(:,k+1)-theta_15(3))*(theta_15(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P15(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P15(3,3,k+1)+(theta_15(2)*w_g'*h_g(:,k+1))^2);
    u_dual_16(k+1) = ((input_ref(k+1)-theta_16(1)*w_f'*h_f(:,k+1)-theta_16(3))*(theta_16(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P16(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P16(3,3,k+1)+(theta_16(2)*w_g'*h_g(:,k+1))^2);
    u_dual_17(k+1) = ((input_ref(k+1)-theta_17(1)*w_f'*h_f(:,k+1)-theta_17(3))*(theta_17(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P17(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P17(3,3,k+1)+(theta_17(2)*w_g'*h_g(:,k+1))^2);
    u_dual_18(k+1) = ((input_ref(k+1)-theta_18(1)*w_f'*h_f(:,k+1)-theta_18(3))*(theta_18(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P18(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P18(3,3,k+1)+(theta_18(2)*w_g'*h_g(:,k+1))^2);
    u_dual_19(k+1) = ((input_ref(k+1)-theta_19(1)*w_f'*h_f(:,k+1)-theta_19(3))*(theta_19(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P19(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P19(3,3,k+1)+(theta_19(2)*w_g'*h_g(:,k+1))^2);
    u_dual_20(k+1) = ((input_ref(k+1)-theta_20(1)*w_f'*h_f(:,k+1)-theta_20(3))*(theta_20(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P20(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P20(3,3,k+1)+(theta_20(2)*w_g'*h_g(:,k+1))^2);
    u_dual_21(k+1) = ((input_ref(k+1)-theta_21(1)*w_f'*h_f(:,k+1)-theta_21(3))*(theta_21(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P21(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P21(3,3,k+1)+(theta_21(2)*w_g'*h_g(:,k+1))^2);
    u_dual_22(k+1) = ((input_ref(k+1)-theta_22(1)*w_f'*h_f(:,k+1)-theta_22(3))*(theta_22(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P22(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P22(3,3,k+1)+(theta_22(2)*w_g'*h_g(:,k+1))^2);
    u_dual_23(k+1) = ((input_ref(k+1)-theta_23(1)*w_f'*h_f(:,k+1)-theta_23(3))*(theta_23(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P23(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P23(3,3,k+1)+(theta_23(2)*w_g'*h_g(:,k+1))^2);
    u_dual_24(k+1) = ((input_ref(k+1)-theta_24(1)*w_f'*h_f(:,k+1)-theta_24(3))*(theta_24(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P24(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P24(3,3,k+1)+(theta_24(2)*w_g'*h_g(:,k+1))^2);
    u_dual_25(k+1) = ((input_ref(k+1)-theta_25(1)*w_f'*h_f(:,k+1)-theta_25(3))*(theta_25(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P25(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P25(3,3,k+1)+(theta_25(2)*w_g'*h_g(:,k+1))^2);
    u_dual_26(k+1) = ((input_ref(k+1)-theta_26(1)*w_f'*h_f(:,k+1)-theta_26(3))*(theta_26(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P26(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P26(3,3,k+1)+(theta_26(2)*w_g'*h_g(:,k+1))^2);
    u_dual_27(k+1) = ((input_ref(k+1)-theta_27(1)*w_f'*h_f(:,k+1)-theta_27(3))*(theta_27(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P27(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P27(3,3,k+1)+(theta_27(2)*w_g'*h_g(:,k+1))^2);
    u_dual_28(k+1) = ((input_ref(k+1)-theta_28(1)*w_f'*h_f(:,k+1)-theta_28(3))*(theta_28(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P28(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P28(3,3,k+1)+(theta_28(2)*w_g'*h_g(:,k+1))^2);
    u_dual_29(k+1) = ((input_ref(k+1)-theta_29(1)*w_f'*h_f(:,k+1)-theta_29(3))*(theta_29(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P29(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P29(3,3,k+1)+(theta_29(2)*w_g'*h_g(:,k+1))^2);
    u_dual_30(k+1) = ((input_ref(k+1)-theta_30(1)*w_f'*h_f(:,k+1)-theta_30(3))*(theta_30(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P30(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P30(3,3,k+1)+(theta_30(2)*w_g'*h_g(:,k+1))^2);
    u_dual_31(k+1) = ((input_ref(k+1)-theta_31(1)*w_f'*h_f(:,k+1)-theta_31(3))*(theta_31(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P31(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P31(3,3,k+1)+(theta_31(2)*w_g'*h_g(:,k+1))^2);
    u_dual_32(k+1) = ((input_ref(k+1)-theta_32(1)*w_f'*h_f(:,k+1)-theta_32(3))*(theta_32(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P32(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P32(3,3,k+1)+(theta_32(2)*w_g'*h_g(:,k+1))^2);
    u_dual_33(k+1) = ((input_ref(k+1)-theta_33(1)*w_f'*h_f(:,k+1)-theta_33(3))*(theta_33(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P33(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P33(3,3,k+1)+(theta_33(2)*w_g'*h_g(:,k+1))^2);
    u_dual_34(k+1) = ((input_ref(k+1)-theta_34(1)*w_f'*h_f(:,k+1)-theta_34(3))*(theta_34(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P34(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P34(3,3,k+1)+(theta_34(2)*w_g'*h_g(:,k+1))^2);
    u_dual_35(k+1) = ((input_ref(k+1)-theta_35(1)*w_f'*h_f(:,k+1)-theta_35(3))*(theta_35(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P35(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P35(3,3,k+1)+(theta_35(2)*w_g'*h_g(:,k+1))^2);
    u_dual_36(k+1) = ((input_ref(k+1)-theta_36(1)*w_f'*h_f(:,k+1)-theta_36(3))*(theta_36(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P36(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P36(3,3,k+1)+(theta_36(2)*w_g'*h_g(:,k+1))^2);
    u_dual_37(k+1) = ((input_ref(k+1)-theta_37(1)*w_f'*h_f(:,k+1)-theta_37(3))*(theta_37(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P37(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P37(3,3,k+1)+(theta_37(2)*w_g'*h_g(:,k+1))^2);
    u_dual_38(k+1) = ((input_ref(k+1)-theta_38(1)*w_f'*h_f(:,k+1)-theta_38(3))*(theta_38(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P38(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P38(3,3,k+1)+(theta_38(2)*w_g'*h_g(:,k+1))^2);
    u_dual_39(k+1) = ((input_ref(k+1)-theta_39(1)*w_f'*h_f(:,k+1)-theta_39(3))*(theta_39(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P39(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P39(3,3,k+1)+(theta_39(2)*w_g'*h_g(:,k+1))^2);
    u_dual_40(k+1) = ((input_ref(k+1)-theta_40(1)*w_f'*h_f(:,k+1)-theta_40(3))*(theta_40(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P40(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P40(3,3,k+1)+(theta_40(2)*w_g'*h_g(:,k+1))^2);
    u_dual_41(k+1) = ((input_ref(k+1)-theta_41(1)*w_f'*h_f(:,k+1)-theta_41(3))*(theta_41(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P41(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P41(3,3,k+1)+(theta_41(2)*w_g'*h_g(:,k+1))^2);
    u_dual_42(k+1) = ((input_ref(k+1)-theta_42(1)*w_f'*h_f(:,k+1)-theta_42(3))*(theta_42(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P42(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P42(3,3,k+1)+(theta_42(2)*w_g'*h_g(:,k+1))^2);
    u_dual_43(k+1) = ((input_ref(k+1)-theta_43(1)*w_f'*h_f(:,k+1)-theta_43(3))*(theta_43(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P43(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P43(3,3,k+1)+(theta_43(2)*w_g'*h_g(:,k+1))^2);
    u_dual_44(k+1) = ((input_ref(k+1)-theta_44(1)*w_f'*h_f(:,k+1)-theta_44(3))*(theta_44(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P44(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P44(3,3,k+1)+(theta_44(2)*w_g'*h_g(:,k+1))^2);
    u_dual_45(k+1) = ((input_ref(k+1)-theta_45(1)*w_f'*h_f(:,k+1)-theta_45(3))*(theta_45(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P45(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P45(3,3,k+1)+(theta_45(2)*w_g'*h_g(:,k+1))^2);
    u_dual_46(k+1) = ((input_ref(k+1)-theta_46(1)*w_f'*h_f(:,k+1)-theta_46(3))*(theta_46(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P46(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P46(3,3,k+1)+(theta_46(2)*w_g'*h_g(:,k+1))^2);
    u_dual_47(k+1) = ((input_ref(k+1)-theta_47(1)*w_f'*h_f(:,k+1)-theta_47(3))*(theta_47(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P47(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P47(3,3,k+1)+(theta_47(2)*w_g'*h_g(:,k+1))^2);
    u_dual_48(k+1) = ((input_ref(k+1)-theta_48(1)*w_f'*h_f(:,k+1)-theta_48(3))*(theta_48(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P48(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P48(3,3,k+1)+(theta_48(2)*w_g'*h_g(:,k+1))^2);
    u_dual_49(k+1) = ((input_ref(k+1)-theta_49(1)*w_f'*h_f(:,k+1)-theta_49(3))*(theta_49(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P49(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P49(3,3,k+1)+(theta_49(2)*w_g'*h_g(:,k+1))^2);
    u_dual_50(k+1) = ((input_ref(k+1)-theta_50(1)*w_f'*h_f(:,k+1)-theta_50(3))*(theta_50(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P50(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P50(3,3,k+1)+(theta_50(2)*w_g'*h_g(:,k+1))^2);
    u_dual_51(k+1) = ((input_ref(k+1)-theta_51(1)*w_f'*h_f(:,k+1)-theta_51(3))*(theta_51(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P51(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P51(3,3,k+1)+(theta_51(2)*w_g'*h_g(:,k+1))^2);
    u_dual_52(k+1) = ((input_ref(k+1)-theta_52(1)*w_f'*h_f(:,k+1)-theta_52(3))*(theta_52(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P52(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P52(3,3,k+1)+(theta_52(2)*w_g'*h_g(:,k+1))^2);
    u_dual_53(k+1) = ((input_ref(k+1)-theta_53(1)*w_f'*h_f(:,k+1)-theta_53(3))*(theta_53(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P53(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P53(3,3,k+1)+(theta_53(2)*w_g'*h_g(:,k+1))^2);
    u_dual_54(k+1) = ((input_ref(k+1)-theta_54(1)*w_f'*h_f(:,k+1)-theta_54(3))*(theta_54(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P54(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P54(3,3,k+1)+(theta_54(2)*w_g'*h_g(:,k+1))^2);
    u_dual_55(k+1) = ((input_ref(k+1)-theta_55(1)*w_f'*h_f(:,k+1)-theta_55(3))*(theta_55(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P55(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P55(3,3,k+1)+(theta_55(2)*w_g'*h_g(:,k+1))^2);
    u_dual_56(k+1) = ((input_ref(k+1)-theta_56(1)*w_f'*h_f(:,k+1)-theta_56(3))*(theta_56(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P56(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P56(3,3,k+1)+(theta_56(2)*w_g'*h_g(:,k+1))^2);
    u_dual_57(k+1) = ((input_ref(k+1)-theta_57(1)*w_f'*h_f(:,k+1)-theta_57(3))*(theta_57(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P57(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P57(3,3,k+1)+(theta_57(2)*w_g'*h_g(:,k+1))^2);
    u_dual_58(k+1) = ((input_ref(k+1)-theta_58(1)*w_f'*h_f(:,k+1)-theta_58(3))*(theta_58(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P58(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P58(3,3,k+1)+(theta_58(2)*w_g'*h_g(:,k+1))^2);
    u_dual_59(k+1) = ((input_ref(k+1)-theta_59(1)*w_f'*h_f(:,k+1)-theta_59(3))*(theta_59(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P59(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P59(3,3,k+1)+(theta_59(2)*w_g'*h_g(:,k+1))^2);
    u_dual_60(k+1) = ((input_ref(k+1)-theta_60(1)*w_f'*h_f(:,k+1)-theta_60(3))*(theta_60(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P60(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P60(3,3,k+1)+(theta_60(2)*w_g'*h_g(:,k+1))^2);
    u_dual_61(k+1) = ((input_ref(k+1)-theta_61(1)*w_f'*h_f(:,k+1)-theta_61(3))*(theta_61(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P61(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P61(3,3,k+1)+(theta_61(2)*w_g'*h_g(:,k+1))^2);
    u_dual_62(k+1) = ((input_ref(k+1)-theta_62(1)*w_f'*h_f(:,k+1)-theta_62(3))*(theta_62(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P62(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P62(3,3,k+1)+(theta_62(2)*w_g'*h_g(:,k+1))^2);
    u_dual_63(k+1) = ((input_ref(k+1)-theta_63(1)*w_f'*h_f(:,k+1)-theta_63(3))*(theta_63(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P63(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P63(3,3,k+1)+(theta_63(2)*w_g'*h_g(:,k+1))^2);
    u_dual_64(k+1) = ((input_ref(k+1)-theta_64(1)*w_f'*h_f(:,k+1)-theta_64(3))*(theta_64(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P64(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P64(3,3,k+1)+(theta_64(2)*w_g'*h_g(:,k+1))^2);
    u_dual_65(k+1) = ((input_ref(k+1)-theta_65(1)*w_f'*h_f(:,k+1)-theta_65(3))*(theta_65(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P65(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P65(3,3,k+1)+(theta_65(2)*w_g'*h_g(:,k+1))^2);
    u_dual_66(k+1) = ((input_ref(k+1)-theta_66(1)*w_f'*h_f(:,k+1)-theta_66(3))*(theta_66(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P66(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P66(3,3,k+1)+(theta_66(2)*w_g'*h_g(:,k+1))^2);
    u_dual_67(k+1) = ((input_ref(k+1)-theta_67(1)*w_f'*h_f(:,k+1)-theta_67(3))*(theta_67(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P67(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P67(3,3,k+1)+(theta_67(2)*w_g'*h_g(:,k+1))^2);
    u_dual_68(k+1) = ((input_ref(k+1)-theta_68(1)*w_f'*h_f(:,k+1)-theta_68(3))*(theta_68(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P68(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P68(3,3,k+1)+(theta_68(2)*w_g'*h_g(:,k+1))^2);
    u_dual_69(k+1) = ((input_ref(k+1)-theta_69(1)*w_f'*h_f(:,k+1)-theta_69(3))*(theta_69(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P69(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P69(3,3,k+1)+(theta_69(2)*w_g'*h_g(:,k+1))^2);
    u_dual_70(k+1) = ((input_ref(k+1)-theta_70(1)*w_f'*h_f(:,k+1)-theta_70(3))*(theta_70(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P70(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P70(3,3,k+1)+(theta_70(2)*w_g'*h_g(:,k+1))^2);
    u_dual_71(k+1) = ((input_ref(k+1)-theta_71(1)*w_f'*h_f(:,k+1)-theta_71(3))*(theta_71(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P71(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P71(3,3,k+1)+(theta_71(2)*w_g'*h_g(:,k+1))^2);
    u_dual_72(k+1) = ((input_ref(k+1)-theta_72(1)*w_f'*h_f(:,k+1)-theta_72(3))*(theta_72(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P72(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P72(3,3,k+1)+(theta_72(2)*w_g'*h_g(:,k+1))^2);
    u_dual_73(k+1) = ((input_ref(k+1)-theta_73(1)*w_f'*h_f(:,k+1)-theta_73(3))*(theta_73(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P73(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P73(3,3,k+1)+(theta_73(2)*w_g'*h_g(:,k+1))^2);
    u_dual_74(k+1) = ((input_ref(k+1)-theta_74(1)*w_f'*h_f(:,k+1)-theta_74(3))*(theta_74(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P74(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P74(3,3,k+1)+(theta_74(2)*w_g'*h_g(:,k+1))^2);
    u_dual_75(k+1) = ((input_ref(k+1)-theta_75(1)*w_f'*h_f(:,k+1)-theta_75(3))*(theta_75(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P75(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P75(3,3,k+1)+(theta_75(2)*w_g'*h_g(:,k+1))^2);
    u_dual_76(k+1) = ((input_ref(k+1)-theta_76(1)*w_f'*h_f(:,k+1)-theta_76(3))*(theta_76(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P76(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P76(3,3,k+1)+(theta_76(2)*w_g'*h_g(:,k+1))^2);
    u_dual_77(k+1) = ((input_ref(k+1)-theta_77(1)*w_f'*h_f(:,k+1)-theta_77(3))*(theta_77(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P77(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P77(3,3,k+1)+(theta_77(2)*w_g'*h_g(:,k+1))^2);
    u_dual_78(k+1) = ((input_ref(k+1)-theta_78(1)*w_f'*h_f(:,k+1)-theta_78(3))*(theta_78(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P78(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P78(3,3,k+1)+(theta_78(2)*w_g'*h_g(:,k+1))^2);
    u_dual_79(k+1) = ((input_ref(k+1)-theta_79(1)*w_f'*h_f(:,k+1)-theta_79(3))*(theta_79(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P79(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P79(3,3,k+1)+(theta_79(2)*w_g'*h_g(:,k+1))^2);
    u_dual_80(k+1) = ((input_ref(k+1)-theta_80(1)*w_f'*h_f(:,k+1)-theta_80(3))*(theta_80(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P80(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P80(3,3,k+1)+(theta_80(2)*w_g'*h_g(:,k+1))^2);
    u_dual_81(k+1) = ((input_ref(k+1)-theta_81(1)*w_f'*h_f(:,k+1)-theta_81(3))*(theta_81(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P81(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P81(3,3,k+1)+(theta_81(2)*w_g'*h_g(:,k+1))^2);
    u_dual_82(k+1) = ((input_ref(k+1)-theta_82(1)*w_f'*h_f(:,k+1)-theta_82(3))*(theta_82(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P82(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P82(3,3,k+1)+(theta_82(2)*w_g'*h_g(:,k+1))^2);
    u_dual_83(k+1) = ((input_ref(k+1)-theta_83(1)*w_f'*h_f(:,k+1)-theta_83(3))*(theta_83(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P83(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P83(3,3,k+1)+(theta_83(2)*w_g'*h_g(:,k+1))^2);
    u_dual_84(k+1) = ((input_ref(k+1)-theta_84(1)*w_f'*h_f(:,k+1)-theta_84(3))*(theta_84(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P84(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P84(3,3,k+1)+(theta_84(2)*w_g'*h_g(:,k+1))^2);
    u_dual_85(k+1) = ((input_ref(k+1)-theta_85(1)*w_f'*h_f(:,k+1)-theta_85(3))*(theta_85(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P85(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P85(3,3,k+1)+(theta_85(2)*w_g'*h_g(:,k+1))^2);
    u_dual_86(k+1) = ((input_ref(k+1)-theta_86(1)*w_f'*h_f(:,k+1)-theta_86(3))*(theta_86(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P86(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P86(3,3,k+1)+(theta_86(2)*w_g'*h_g(:,k+1))^2);
    u_dual_87(k+1) = ((input_ref(k+1)-theta_87(1)*w_f'*h_f(:,k+1)-theta_87(3))*(theta_87(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P87(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P87(3,3,k+1)+(theta_87(2)*w_g'*h_g(:,k+1))^2);
    u_dual_88(k+1) = ((input_ref(k+1)-theta_88(1)*w_f'*h_f(:,k+1)-theta_88(3))*(theta_88(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P88(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P88(3,3,k+1)+(theta_88(2)*w_g'*h_g(:,k+1))^2);
    u_dual_89(k+1) = ((input_ref(k+1)-theta_89(1)*w_f'*h_f(:,k+1)-theta_89(3))*(theta_89(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P89(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P89(3,3,k+1)+(theta_89(2)*w_g'*h_g(:,k+1))^2);
    u_dual_90(k+1) = ((input_ref(k+1)-theta_90(1)*w_f'*h_f(:,k+1)-theta_90(3))*(theta_90(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P90(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P90(3,3,k+1)+(theta_90(2)*w_g'*h_g(:,k+1))^2);
    u_dual_91(k+1) = ((input_ref(k+1)-theta_91(1)*w_f'*h_f(:,k+1)-theta_91(3))*(theta_91(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P91(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P91(3,3,k+1)+(theta_91(2)*w_g'*h_g(:,k+1))^2);
    u_dual_92(k+1) = ((input_ref(k+1)-theta_92(1)*w_f'*h_f(:,k+1)-theta_92(3))*(theta_92(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P92(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P92(3,3,k+1)+(theta_92(2)*w_g'*h_g(:,k+1))^2);
    u_dual_93(k+1) = ((input_ref(k+1)-theta_93(1)*w_f'*h_f(:,k+1)-theta_93(3))*(theta_93(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P93(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P93(3,3,k+1)+(theta_93(2)*w_g'*h_g(:,k+1))^2);
    u_dual_94(k+1) = ((input_ref(k+1)-theta_94(1)*w_f'*h_f(:,k+1)-theta_94(3))*(theta_94(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P94(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P94(3,3,k+1)+(theta_94(2)*w_g'*h_g(:,k+1))^2);
    u_dual_95(k+1) = ((input_ref(k+1)-theta_95(1)*w_f'*h_f(:,k+1)-theta_95(3))*(theta_95(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P95(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P95(3,3,k+1)+(theta_95(2)*w_g'*h_g(:,k+1))^2);
    u_dual_96(k+1) = ((input_ref(k+1)-theta_96(1)*w_f'*h_f(:,k+1)-theta_96(3))*(theta_96(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P96(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P96(3,3,k+1)+(theta_96(2)*w_g'*h_g(:,k+1))^2);
    u_dual_97(k+1) = ((input_ref(k+1)-theta_97(1)*w_f'*h_f(:,k+1)-theta_97(3))*(theta_97(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P97(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P97(3,3,k+1)+(theta_97(2)*w_g'*h_g(:,k+1))^2);
    u_dual_98(k+1) = ((input_ref(k+1)-theta_98(1)*w_f'*h_f(:,k+1)-theta_98(3))*(theta_98(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P98(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P98(3,3,k+1)+(theta_98(2)*w_g'*h_g(:,k+1))^2);
    u_dual_99(k+1) = ((input_ref(k+1)-theta_99(1)*w_f'*h_f(:,k+1)-theta_99(3))*(theta_99(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P99(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P99(3,3,k+1)+(theta_99(2)*w_g'*h_g(:,k+1))^2);
    u_dual_100(k+1) = ((input_ref(k+1)-theta_100(1)*w_f'*h_f(:,k+1)-theta_100(3))*(theta_100(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P100(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P100(3,3,k+1)+(theta_100(2)*w_g'*h_g(:,k+1))^2);
    u_dual_101(k+1) = ((input_ref(k+1)-theta_101(1)*w_f'*h_f(:,k+1)-theta_101(3))*(theta_101(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P101(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P101(3,3,k+1)+(theta_101(2)*w_g'*h_g(:,k+1))^2);
    u_dual_102(k+1) = ((input_ref(k+1)-theta_102(1)*w_f'*h_f(:,k+1)-theta_102(3))*(theta_102(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P102(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P102(3,3,k+1)+(theta_102(2)*w_g'*h_g(:,k+1))^2);
    u_dual_103(k+1) = ((input_ref(k+1)-theta_103(1)*w_f'*h_f(:,k+1)-theta_103(3))*(theta_103(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P103(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P103(3,3,k+1)+(theta_103(2)*w_g'*h_g(:,k+1))^2);
    u_dual_104(k+1) = ((input_ref(k+1)-theta_104(1)*w_f'*h_f(:,k+1)-theta_104(3))*(theta_104(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P104(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P104(3,3,k+1)+(theta_104(2)*w_g'*h_g(:,k+1))^2);
    u_dual_105(k+1) = ((input_ref(k+1)-theta_105(1)*w_f'*h_f(:,k+1)-theta_105(3))*(theta_105(2)*w_g'*h_g(:,k+1))-(1-lamda_dual)*[w_f'*h_f(:,k+1) 1]*P105(2:3,3,k+1)*w_g'*h_g(:,k+1))/((1-lamda_dual)*(w_g'*h_g(:,k+1))^2*P105(3,3,k+1)+(theta_105(2)*w_g'*h_g(:,k+1))^2);
