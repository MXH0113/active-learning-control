...
for k = 1:N-1
    ...
    u_dual_3(k) = ((input_ref(k+1)-theta_3(1)*w_f'*h_f(:,k)-theta_3(3))*(theta_3(2)*w_g'*h_g(:,k))-(1-lamda_dual)*[w_f'*h_f(:,k) 1]*P3(1:2,3,k)*w_g'*h_g(:,k))/((1-lamda_dual)*(w_g'*h_g(:,k))^2*P3(3,3,k)+(theta_3(2)*w_g'*h_g(:,k))^2);
    u_dual_4(k) = ((input_ref(k+1)-theta_4(1)*w_f'*h_f(:,k)-theta_4(3))*(theta_4(2)*w_g'*h_g(:,k))-(1-lamda_dual)*[w_f'*h_f(:,k) 1]*P4(1:2,3,k)*w_g'*h_g(:,k))/((1-lamda_dual)*(w_g'*h_g(:,k))^2*P4(3,3,k)+(theta_4(2)*w_g'*h_g(:,k))^2);
    u_dual_5(k) = ((input_ref(k+1)-theta_5(1)*w_f'*h_f(:,k)-theta_5(3))*(theta_5(2)*w_g'*h_g(:,k))-(1-lamda_dual)*[w_f'*h_f(:,k) 1]*P5(1:2,3,k)*w_g'*h_g(:,k))/((1-lamda_dual)*(w_g'*h_g(:,k))^2*P5(3,3,k)+(theta_5(2)*w_g'*h_g(:,k))^2);
    u_dual_6(k) = ((input_ref(k+1)-theta_6(1)*w_f'*h_f(:,k)-theta_6(3))*(theta_6(2)*w_g'*h_g(:,k))-(1-lamda_dual)*[w_f'*h_f(:,k) 1]*P6(1:2,3,k)*w_g'*h_g(:,k))/((1-lamda_dual)*(w_g'*h_g(:,k))^2*P6(3,3,k)+(theta_6(2)*w_g'*h_g(:,k))^2);
    u_dual_7(k) = ((input_ref(k+1)-theta_7(1)*w_f'*h_f(:,k)-theta_7(3))*(theta_7(2)*w_g'*h_g(:,k))-(1-lamda_dual)*[w_f'*h_f(:,k) 1]*P7(1:2,3,k)*w_g'*h_g(:,k))/((1-lamda_dual)*(w_g'*h_g(:,k))^2*P7(3,3,k)+(theta_7(2)*w_g'*h_g(:,k))^2);
    u_dual_8(k) = ((input_ref(k+1)-theta_8(1)*w_f'*h_f(:,k)-theta_8(3))*(theta_8(2)*w_g'*h_g(:,k))-(1-lamda_dual)*[w_f'*h_f(:,k) 1]*P8(1:2,3,k)*w_g'*h_g(:,k))/((1-lamda_dual)*(w_g'*h_g(:,k))^2*P8(3,3,k)+(theta_8(2)*w_g'*h_g(:,k))^2);
    u_dual_9(k) = ((input_ref(k+1)-theta_9(1)*w_f'*h_f(:,k)-theta_9(3))*(theta_9(2)*w_g'*h_g(:,k))-(1-lamda_dual)*[w_f'*h_f(:,k) 1]*P9(1:2,3,k)*w_g'*h_g(:,k))/((1-lamda_dual)*(w_g'*h_g(:,k))^2*P9(3,3,k)+(theta_9(2)*w_g'*h_g(:,k))^2);
    u_dual_10(k) = ((input_ref(k+1)-theta_10(1)*w_f'*h_f(:,k)-theta_10(3))*(theta_10(2)*w_g'*h_g(:,k))-(1-lamda_dual)*[w_f'*h_f(:,k) 1]*P10(1:2,3,k)*w_g'*h_g(:,k))/((1-lamda_dual)*(w_g'*h_g(:,k))^2*P10(3,3,k)+(theta_10(2)*w_g'*h_g(:,k))^2);
    u_dual_11(k) = ((input_ref(k+1)-theta_11(1)*w_f'*h_f(:,k)-theta_11(3))*(theta_11(2)*w_g'*h_g(:,k))-(1-lamda_dual)*[w_f'*h_f(:,k) 1]*P11(1:2,3,k)*w_g'*h_g(:,k))/((1-lamda_dual)*(w_g'*h_g(:,k))^2*P11(3,3,k)+(theta_11(2)*w_g'*h_g(:,k))^2);
    u_dual_12(k) = ((input_ref(k+1)-theta_12(1)*w_f'*h_f(:,k)-theta_12(3))*(theta_12(2)*w_g'*h_g(:,k))-(1-lamda_dual)*[w_f'*h_f(:,k) 1]*P12(1:2,3,k)*w_g'*h_g(:,k))/((1-lamda_dual)*(w_g'*h_g(:,k))^2*P12(3,3,k)+(theta_12(2)*w_g'*h_g(:,k))^2);
    u_dual_13(k) = ((input_ref(k+1)-theta_13(1)*w_f'*h_f(:,k)-theta_13(3))*(theta_13(2)*w_g'*h_g(:,k))-(1-lamda_dual)*[w_f'*h_f(:,k) 1]*P13(1:2,3,k)*w_g'*h_g(:,k))/((1-lamda_dual)*(w_g'*h_g(:,k))^2*P13(3,3,k)+(theta_13(2)*w_g'*h_g(:,k))^2);
    u_dual_14(k) = ((input_ref(k+1)-theta_14(1)*w_f'*h_f(:,k)-theta_14(3))*(theta_14(2)*w_g'*h_g(:,k))-(1-lamda_dual)*[w_f'*h_f(:,k) 1]*P14(1:2,3,k)*w_g'*h_g(:,k))/((1-lamda_dual)*(w_g'*h_g(:,k))^2*P14(3,3,k)+(theta_14(2)*w_g'*h_g(:,k))^2);
    u_dual_15(k) = ((input_ref(k+1)-theta_15(1)*w_f'*h_f(:,k)-theta_15(3))*(theta_15(2)*w_g'*h_g(:,k))-(1-lamda_dual)*[w_f'*h_f(:,k) 1]*P15(1:2,3,k)*w_g'*h_g(:,k))/((1-lamda_dual)*(w_g'*h_g(:,k))^2*P15(3,3,k)+(theta_15(2)*w_g'*h_g(:,k))^2);
    ...
    P1(:,:,k+1) =  log2(prob_coef/q_1+1)*P1(:,:,k);
    P2(:,:,k+1) =  log2(prob_coef/q_2+1)*P2(:,:,k);
    P3(:,:,k+1) =  log2(prob_coef/q_3+1)*P3(:,:,k);
    P4(:,:,k+1) =  log2(prob_coef/q_4+1)*P4(:,:,k);
    P5(:,:,k+1) =  log2(prob_coef/q_5+1)*P5(:,:,k);
    P6(:,:,k+1) =  log2(prob_coef/q_6+1)*P6(:,:,k);
    P7(:,:,k+1) =  log2(prob_coef/q_7+1)*P7(:,:,k);
    P8(:,:,k+1) =  log2(prob_coef/q_8+1)*P8(:,:,k);
    P9(:,:,k+1) =  log2(prob_coef/q_9+1)*P9(:,:,k);
    P10(:,:,k+1) =  log2(prob_coef/q_10+1)*P10(:,:,k);
    P11(:,:,k+1) =  log2(prob_coef/q_11+1)*P11(:,:,k);
    P12(:,:,k+1) =  log2(prob_coef/q_12+1)*P12(:,:,k);
    P13(:,:,k+1) =  log2(prob_coef/q_13+1)*P13(:,:,k);
    P14(:,:,k+1) =  log2(prob_coef/q_14+1)*P14(:,:,k);
    P15(:,:,k+1) =  log2(prob_coef/q_15+1)*P15(:,:,k);
